...
- Design tokens in `src/app/globals.css`. Use `glass`, `glass-strong`, `specular`, `pressable` utilities; radii via the `--r-sm/md/lg/xl` tokens; accent via Tailwind `accent*` colors. Turquoise + white, Apple-like, minimal.
